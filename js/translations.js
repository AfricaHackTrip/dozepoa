[
  {
    icon: 'salamz.png', title: 'Salamz', english_title: 'Greetings', phrases: [
  ...
  {
    icon: 'food.png', title: 'Dish', english_title: 'Food and Drinks' phrases: [
  ...
  {
    icon: 'directions.png', title: 'Kusaka', english_title: 'Directions', phrases: [
